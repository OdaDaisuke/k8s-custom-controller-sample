...
// +kubebuilder:webhook:path=/mutate-view-daisukeoda-github-io-v1-markdownview,mutating=true,failurePolicy=fail,sideEffects=None,groups=view.daisukeoda.github.io,resources=markdownviews,verbs=create;update,versions=v1,name=mmarkdownview.kb.io,admissionReviewVersions=v1
...
// +kubebuilder:webhook:path=/validate-view-daisukeoda-github-io-v1-markdownview,mutating=false,failurePolicy=fail,sideEffects=None,groups=view.daisukeoda.github.io,resources=markdownviews,verbs=create;update,versions=v1,name=vmarkdownview.kb.io,admissionReviewVersions=v1
