...
import (
	...
	viewv1 "github.com/OdaDaisuke/k8s_custom_controller_sample/api/v1"
...
// +kubebuilder:rbac:groups=view.daisukeoda.github.io,resources=markdownviews,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=view.daisukeoda.github.io,resources=markdownviews/status,verbs=get;update;patch
// +kubebuilder:rbac:groups=view.daisukeoda.github.io,resources=markdownviews/finalizers,verbs=update
...
func (r *MarkdownViewReconciler) Reconcile(ctx context.Context, req ctrl.Request) (ctrl.Result, error) {
	...
	if err != nil {
		log.Log.Error(err, "unable to get MarkdownView", "name", req.NamespacedName)
...
func (r *MarkdownViewReconciler) updateStatus(ctx context.Context, mdView viewv1.MarkdownView) (ctrl.Result, error) {
	...
	if dep.Status.AvailableReplicas == 0 {
		status = viewv1.MarkdownViewStatus{
			NotReady: "notready",
		}
	...
	if mdView.Status.Healthy != viewv1.MarkdownViewStatusHealthy {
